...
manan.kakkar.2005@outlook.com | linkedin.com/in/manankakkar11 | github.com/MananKakkar1 | manankakkar.com

## Education
**University of Toronto Mississauga**, Honours Bachelor of Science in Computer Science Specialist, Co-op  
...
**Web / Backend:** Next.js, React, Flask, Express.js, REST APIs, Firebase, Firestore, SQLite, PostgreSQL, MongoDB, JWT  
**Testing / Debugging:** GDB, Valgrind, PyTest, JUnit5, Jest
...
Markham, Ontario | May 2026 - August 2027
- Incoming Full Stack Software Development Engineer Intern.

### Munafah.AI
**Software Engineer Intern**  
Remote | May 2025 - August 2025
- Developed and deployed backend systems for a real-time B2B messaging platform using Node.js, Flask, and Firestore.
- Built AI-assisted moderation workflows for real-time communication systems, strengthening experience with production AI pipelines.
- Implemented unit and integration testing to support stable deployments and production reliability.
- Engineered CI/CD workflows and deployment processes that improved release quality and development velocity.

## Robotics Presentations

### CSC476: Introduction to Continuum Robotics
**University of Toronto Mississauga**
- Presented research papers on continuum robot kinematics, motion planning, control, and sensing.
- Delivered a group presentation on **Multi-solution Solver for the Inverse Kinematics of 3-Section Constant-Curvature Robots**, covering an archaeology-focused perspective of the paper.
- Delivered a presenter group talk on **On an Improved State Parametrization for Soft Robots With Piecewise Constant Curvature and Its Use in Model Based Control**.
...
### EmberHacks 2025
- Won **Best Use of Auth0** and finished in the **Top 4** for building ETA, a personalized interactive AI learning assistant.
