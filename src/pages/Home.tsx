  ...
  const handleTechDpad = (cardIdx: number, direction: "next" | "prev") => {
    setDisplayedTechs((prev) => {
      ...
      if (direction === "next") {
        ...
        if (updated.filter((v, i) => i !== cardIdx).includes(updated[cardIdx])) {
  ...
  return (
    <div className="home-page-root">
      ...
      <div className="tech-stack-grid-wrapper">
        ...
        {/* --- Add this block for 3 Gameboy-style tech cards --- */}
        <div className="home-projects-list">
                      ...
                      <div className="gameboy-controls">
                        ...
                        <div className="gameboy-dpad">
                          <div className="dpad">
                            ...
                            <div
                              className="dpad-center"
                              // Optionally keep this for a reset or no-op
                            ></div>
                            <div
                              className="dpad-up"
